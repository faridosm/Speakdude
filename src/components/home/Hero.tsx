...
export function Hero({ user, onNavigate }: HeroProps) {
  const languageCards = [
    // Top arc - very close to character's head area
    { name: 'English', flag: '🇺🇸', position: 'top-8 left-1/2 transform -translate-x-1/2 -translate-y-4', delay: '0s', rotation: 'rotate-2' },
    { name: 'Spanish', flag: '🇪🇸', position: 'top-12 left-1/4 transform -translate-x-8', delay: '0.5s', rotation: '-rotate-1' },
    
    // Upper sides - close to shoulders/arms
    { name: 'Hindi', flag: '🇮🇳', position: 'top-1/3 left-8', delay: '1s', rotation: 'rotate-3' },
    { name: 'Greek', flag: '🇬🇷', position: 'top-1/3 right-8', delay: '1.5s', rotation: '-rotate-2' },
    
    // Mid sides - close to torso/chair
    { name: 'Turkish', flag: '🇹🇷', position: 'top-1/2 left-4', delay: '2s', rotation: 'rotate-1' },
    { name: 'German', flag: '🇩🇪', position: 'top-1/2 right-4', delay: '2.5s', rotation: '-rotate-3' },
    
    // Bottom arc - close to legs/chair base
    { name: 'Italian', flag: '🇮🇹', position: 'bottom-16 left-1/3', delay: '3s', rotation: 'rotate-2' },
    { name: 'Russian', flag: '🇷🇺', position: 'bottom-16 right-1/4', delay: '3.5s', rotation: '-rotate-1' },
  ];
    ...
    <div className="min-h-screen relative overflow-hidden" style={{
      ...
      <nav className="relative z-10 px-6 py-3">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gray-900 rounded-full px-6 py-2.5 flex items-center justify-between shadow-lg">
            {/* Logo */}
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white font-bold text-lg">SpeakDude</span>
            </div>
            
            {/* Navigation Items */}
            <div className="hidden lg:flex items-center space-x-1">
              <button className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-4 py-2 rounded-full text-sm font-semibold hover:shadow-lg transition-all duration-200 flex items-center space-x-2">
                <span>Home</span>
              </button>
              <button 
                onClick={handleFeatureClick}
                className="text-gray-300 hover:text-white px-3 py-2 text-sm font-medium transition-colors rounded-full hover:bg-gray-800"
              >
                Feature
              </button>
              <button 
              ...
              {user ? (
                ...
                <>
                  ...
                  <button 
                    ...
                    className="bg-white text-gray-900 hover:bg-gray-100 px-3 py-1.5 rounded-full text-sm font-semibold transition-all duration-200"
                  >
                    Sign Up
                  </button>
                </>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="text-center mb-12 pt-8">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight tracking-tight">
            <span className="text-gray-900">You Learned A Language</span>
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">But Can't Speak It?</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto mb-8 relative flex justify-center">
          ...
          <div className="relative">
            ...
            {/* Floating Language Cards - Tight circular layout around character */}
            {languageCards.map((card, index) => (
              <div
                key={card.name}
                className={`absolute ${card.position} z-20 animate-bounce ${card.rotation}`}
                style={{
            ...
            <div className="absolute top-1/4 left-4 z-15 animate-bounce" style={{ animationDelay: '1.5s', animationDuration: '4s' }}>
              <div className="w-1 h-1 bg-orange-400/60 rounded-full"></div>
            </div>
            <div className="absolute bottom-1/4 right-4 z-15 animate-bounce" style={{ animationDelay: '2.5s', animationDuration: '4s' }}>
