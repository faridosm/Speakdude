...
function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* No Judgment. Just Progress - Original Section */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We believe in a world where everyone deserves to learn without fear. SpeakDude provides a completely private, encouraging environment — no teachers watching, no peers judging.
            </p>
          </div>
